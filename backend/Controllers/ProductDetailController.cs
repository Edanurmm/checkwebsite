    ...
    public class ProductDetailController : ControllerBase
    {
        ...
        public async Task<ActionResult<IEnumerable<ChkProductDetail>>> GetChkProductDetailByProductId(int productId)
        {
            var chkProductDetailList = await _context.ChkProductDetails
                                                            ...
                                                            .OrderBy(pd=>pd.Price).ToListAsync(); //fiyata göre sırala
        ...
        // GET: api/ProductDetail/GetByFilter?productId=1&freeShipping=true&freeReturn=false   //freeReturn=IsReturnChargable
        [HttpGet("GetByFilter")]
